...
public class FacGooglePlace {
    ...
    public double getResultsRating() {
        return resultsRating;
    }

    public void setResultsRating(double resultsRating) {
    ...
    private void unpackNested(Map<String,Object> results[]) {
        ...
        this.resultsRating = (double)results[0].get("rating");
